...
namespace ApiVersioning.Controllers.v1
{
    ...
    public class EmployeeController(IEmployeeService employeeService) : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllEmployeeAsyn()
        {
            try
            {
                ...
                if (result.Item2.Any())
                {
                    ...
                    return Ok(ResponseResult<List<EmployeeDto>>.Sucess(result.Item2, "Employee found in V1 Controller"));
                }
                else
                {
                    return Ok(ResponseResult<List<EmployeeDto>>.Failure(null, "No Employee Found  in V1 Controller"));
                }
                if (result.Item1 == 2)
                {
                    return BadRequest("Technical error, Something went Wrong  in V1 Controller");
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> CreateEmployee([FromBody]EmployeeDto employeeDto)
        {
            ...
            {
                return Ok(ResponseResult<string>.Failure(null, "Employee not created, due to some technical error  in V1 Controller"));
            }
        }
        ...
        public async Task<IActionResult> UpdateEmployee([FromBody] EmployeeDto employeeDto)
        {
            ...
            {
                return Ok(ResponseResult<string>.Failure(null, "Employee not updated, due to some technical error  in V1 Controller"));
            }
        }
        ...
        public async Task<IActionResult> DeleteEmployee(Guid Id)
        {
            ...
            {
                return Ok(ResponseResult<string>.Failure(null, "Employee not deleted, due to some technical error  in V1 Controller"));
            }
        }
        ...
        public async Task<IActionResult> GetEmployeeById([FromRoute]Guid Id)
        {
            try
            {
                ...
                if (result.Item1 == 0)
                {
                    return Ok(ResponseResult<EmployeeDto>.Failure(result.Item2, "Employee not found  in V1 Controller"));
                }
                else
                {
                    return Ok(ResponseResult<EmployeeDto>.Sucess(result.Item2, "Employee found  in V1 Controller"));
                }
            }
            catch (Exception ex)
            {
                return Ok(ResponseResult<EmployeeDto>.Failure(null, "Employee not found, due to some technical error  in V1 Controller"));
            }
        }
